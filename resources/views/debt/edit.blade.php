...
<div class="main-content-wrap">
    ...
    <div class="wg-box">
        ...
        <form class="form-new-product form-style-1" action="{{ route('debt.update',$data->id) }}" method="POST">
            @csrf
            ...
            <fieldset class="name">
                ...
                <input class="flex-grow" type="text" placeholder="Person name" name="person_name"
                    value="{{ old('person_name',$data->person_name) }}" required>
            </fieldset>
            ...
            <fieldset class="name">
                ...
                <div class="select flex-grow">
                    <select name="type" required>
                        ...
                        <option value="take" {{ old('type' ,$data->type) == 'take' ? 'selected' : '' }}>Take</option>
                        <option value="give" {{ old('type' ,$data->type) == 'give' ? 'selected' : ''  }}>Give</option>
                    </select>
                </div>
            </fieldset>
            ...
            <fieldset class="name">
                ...
                <input class="flex-grow" type="text" placeholder="Short note" name="note" value="{{ old('note',$data->note) }}">
            </fieldset>
