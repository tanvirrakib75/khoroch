...
<!-- Add Transfer Modal Start From Here  -->
                        ...
                        <form class="form-new-product form-style-1" action="{{ route('transfer.store') }}" method="POST"
                            ...
                            <fieldset class="name">
                                ...
                                <input class="flex-grow" type="text" placeholder="bKash/Nagad/Bank/Rocket Name"
                                    name="from_account" value="{{ old('from_account')}}" tabindex="0"
                                    aria-required="true" required="">
                            </fieldset>
                            <fieldset class="name">
                                ...
                                <input class="flex-grow" type="text" placeholder="From Account Number"
                                    name="from_account_number" value="{{ old('from_account_number')}}" tabindex="0"
                                    aria-required="true" required="">
                            </fieldset>
                            <fieldset class="name">
                            ...
                            <fieldset class="name">
                                ...
                                <input class="flex-grow" type="text" placeholder="To Account Number"
                                    name="to_account_number" value="{{ old('to_account_number')}}" tabindex="0"
                                    aria-required="true" required="">
                            </fieldset>
                            <fieldset class="name">
